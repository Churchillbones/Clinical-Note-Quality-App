...
def grade_via_api():
    ...
    try:
        ...
        logger.info(f"Received API request for /api/grade with note: {clinical_note[:100]}...")
...
if __name__ == '__main__':
    ...
    # The logger configuration above will apply.
    app.run(debug=app.config.get("DEBUG", False), host=app.config.get("HOST", "127.0.0.1"), port=app.config.get("PORT", 5000))
